        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              <h3 class="d-inline-block d-sm-none">Ruko 03 - Putih Hijau</h3>
              <div class="col-12">
                <img src="dist/img/display03.png" class="product-image" alt="Product Image">
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3">Ruko 03 - Putih Hijau</h3>
